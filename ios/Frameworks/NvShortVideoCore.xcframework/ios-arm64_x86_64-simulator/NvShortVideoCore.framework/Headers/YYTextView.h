...
@protocol YYTextViewTextChangedDelegate <NSObject>

- (void)updateLayoutWithText:(NSMutableAttributedString *)text;
...
@property (nullable, nonatomic, weak) id<YYTextViewTextChangedDelegate> layoutDelegate;
