...
public class BackgroundBottomView extends LinearLayout {
        ...
        for (int i = 0; i < styleInfos.size(); i++) {
            ...
            if (TextUtils.isEmpty(filePath) && TextUtils.isEmpty(nowClipBackgroundValue)) {
                break;
                    ...
                    && nowClipBackgroundValue.contains(filePath)) {
                position = i;
                break;
            }
        }
    ...
    /**
     * 添加本地背景样式
     *Add local background style
     * @param filePath filePath
     */
    public void addBackgroundStyle(String filePath) {
        mBackgroundStyleView.addBackgroundImage(filePath);
    }
