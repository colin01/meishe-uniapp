...
public class CaptionInfo {
     ...
     * 0默认,1竖版,2横版
     * Subtitle direction
     * 0 Default,1 vertical version,2 horizontal version
     */
     ...
     * */
    private String mCaptionShadowColor;
    /*
     * 字幕背景圆角
     * Subtitle color
     * */
     ...
     * shadow opacity
     * */
    private float misShadowOpacity;
    /*
     * 是否有下划线
    ...
    public String getShadowColor() {
        return mCaptionShadowColor;
    }

    public void setShadowColor(String captionShadowColor) {
        this.mCaptionShadowColor = captionShadowColor;
    }
    ...
    public float getShadowOpacity() {
        return misShadowOpacity;
    }

    public void setShadowOpacity(float misShadowOpacity) {
        this.misShadowOpacity = misShadowOpacity;
    }
    ...
    public CaptionInfo clone() {
        ...
        newCaptionInfo.setShadowOpacity(this.getShadowOpacity());
        newCaptionInfo.setShadow(this.isShadow());
        newCaptionInfo.setShadowColor(this.getShadowColor());
