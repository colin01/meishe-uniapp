...
public class FileQuickSplicingActivity extends BaseActivity {
    ...
    protected int initRootView() {
        ...
        return R.layout.activity_quick_trim;
    }
    ...
    protected void initViews() {
        ...
        mProgressBar = findViewById(R.id.pb_quick_trim);
    }
    ...
    protected void initTitle() {
        ...
        mTitleBar.setOnTitleBarClickListener(new OnTitleBarClickListener() {
            ...
            public void OnRightTextClick() {
                ...
                mCompileVideoPath = PathUtils.getQuickSplicingVideoSavePath(fileName);
                mStreamingContext.stop();
                ...
                nvsPassthroughConvertor.convertMediaFile(passthroughFileInfos, mCompileVideoPath, null, 0);
    ...
    class FilePassThroughConvertorCallback implements NvsPassthroughConvertor.PassthroughConvertorCallback {
        ...
        public void onFinish(long l, int i, String s) {
            ...
            ToastUtils.showShort(String.format(getResources().getString(R.string.compile_video_success), mCompileVideoPath));
        }
