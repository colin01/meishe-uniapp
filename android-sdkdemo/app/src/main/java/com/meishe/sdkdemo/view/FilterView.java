...
public class FilterView extends RelativeLayout {
    private MagicProgress mIntensitySeekBar;
    ...
    public void setIntensitySeekBarVisibility(int visibility) {
        ...
        mIntensityText.setVisibility(visibility);
    }
    ...
    private void init(Context context) {
        ...
        mIntensitySeekBar = (MagicProgress) rootView.findViewById(R.id.intensitySeekBar);
        ...
        mIntensitySeekBar.setPointProgress(0);
        mIntensitySeekBar.setMax(100);
        mIntensitySeekBar.setShowBreak(false);
        mIntensitySeekBar.setBreakProgress(0);
        mIntensitySeekBar.setShowTextEnable(false);
        ...
        mIntensitySeekBar.setOnProgressChangeListener(new MagicProgress.OnProgressChangeListener() {
            @SuppressLint("StringFormatMatches")
            @Override
            public void onProgressChange(int progress, boolean fromUser) {
                if (mFilterListener != null) {
                    mFilterListener.onIntensity(progress);
                    mIntensityText.setText(String.format(context.getResources().getString(R.string.intensity_value)
                            , progress));
                }
            }
        });
