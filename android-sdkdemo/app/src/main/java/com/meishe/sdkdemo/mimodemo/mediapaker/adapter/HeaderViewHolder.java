    ...
    public void render(String title, boolean state){
        ...
        if (clickType == MediaConstant.TYPE_ITEMCLICK_MULTIPLE){
            if(mLimitMediaCount >= 0)
                ...
                String checkAll = MeicamContextWrap.getInstance().getContext().getResources().getString(R.string.checkAll);
                String cancleCheckAll =  MeicamContextWrap.getInstance().getContext().getResources().getString(R.string.cancelCheckAll);
