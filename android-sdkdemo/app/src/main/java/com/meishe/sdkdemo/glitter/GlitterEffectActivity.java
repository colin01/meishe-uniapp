...
public class GlitterEffectActivity extends BaseActivity implements GlitterEffectInterface {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.startRecording_button) {
            if (mPreviewFragment.stopRecord()) {
                return;
            }
            startRecord();
        } else if (id == R.id.glitter_effect_close) {
            finish();
        } else if (id == R.id.glitter_effect_expose) {
        ...
        } else if (id == R.id.glitter_effect_switch) {
            mPreviewFragment.changeCurrentDeviceIndex();
        } else if (id == R.id.glitter_effect_style_tv) {
            showDialogView(mDisplayDialog, mStyleView);
        } else if (id == R.id.glitter_effect_strength_tv) {
    ...
    protected void initData() {
        ...
        flashEffectBeans.add(new GlitterEffectBean("assets:/glitter/star3.png", "file:///android_asset/glitter/star3.png", getString(R.string.star3)));
        flashEffectBeans.add(new GlitterEffectBean("assets:/glitter/star4.png", "file:///android_asset/glitter/star4.png", getString(R.string.star4)));
        flashEffectBeans.add(new GlitterEffectBean("assets:/glitter/star5.png", "file:///android_asset/glitter/star5.png", getString(R.string.star5)));
        /*
         * 适配器
         * Adapter
         * */
